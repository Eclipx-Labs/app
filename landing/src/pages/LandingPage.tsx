        ...
        <div style={{
          ...
          <a href="#/status" style={{
            ...
            <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
              <circle cx="4" cy="4" r="4" fill="#22c55e" opacity="0.2" />
              <circle cx="4" cy="4" r="2.2" fill="#22c55e" />
            </svg>
            <span style={{ fontSize: "11px", fontWeight: 600, color: "#22c55e", letterSpacing: "0.06em" }}>All Systems Operational</span>
          </a>
